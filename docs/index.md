...
<div class="nav-cards-container">
  <div class="nav-card" data-category="claudecode">
  ...
  <div class="nav-card" data-category="cursor">
    <div class="nav-card-icon">🎯</div>
    <div class="nav-card-content">
  ...
  <div class="nav-card" data-category="prompt">
    <div class="nav-card-icon">💬</div>
    <div class="nav-card-content">
  ...
  <div class="nav-card" data-category="mcp">
    <div class="nav-card-icon">🔌</div>
    <div class="nav-card-content">
  ...
  <div class="nav-card" data-category="rules">
    <div class="nav-card-icon">📋</div>
    <div class="nav-card-content">
  ...
  <div class="nav-card" data-category="skills">
...
<div class="features-section">
  <a href="https://github.com/qdleader/Awesome-AI-Pedia" target="_blank" class="feature-card">
    <div class="feature-icon">📚</div>
    <h3 class="feature-title">11个AI分类</h3>
    <p class="feature-desc">涵盖Claude Code、Cursor、MCP、Prompt、Rules等全方位AI知识</p>
  ...
  <a href="https://github.com/qdleader/Awesome-AI-Pedia" target="_blank" class="feature-card">
    ...
    <p class="feature-desc">基于VitePress构建，支持Markdown、代码高亮、暗黑模式</p>
    <div class="feature-hover-bg"></div>
  </a>

  <a href="https://github.com/qdleader/Awesome-AI-Pedia" target="_blank" class="feature-card">
    <div class="feature-icon">💡</div>
    <h3 class="feature-title">实战经验分享</h3>
    <p class="feature-desc">从实际项目出发，提供可落地的解决方案</p>
    <div class="feature-hover-bg"></div>
  </a>
</div>
...
/* Features 标题 */
.vp-doc h2:has(+ .features-section) {
  text-align: center;
  font-size: 2.5rem;
  margin-top: 4rem;
  margin-bottom: 3rem;
...
.panda-container .ear-left { transform-origin: 35px 40px; }
.panda-container .ear-right { transform-origin: 85px 40px; animation-delay: 0.2s; }
