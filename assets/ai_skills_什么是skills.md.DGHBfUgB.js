...
</code></pre><h2 id="skills-如何被调用" tabindex="-1">Skills 如何被调用： <a class="header-anchor" href="#skills-如何被调用" aria-label="Permalink to &quot;Skills 如何被调用：&quot;">​</a></h2><pre><code>Skills 是模型调用的——Claude 根据您的请求和 Skill 的描述自主决定何时使用它们。
...
</code></pre><p>​</p>`,22)])])}const u=a(k,[["render",r]]);export{h as __pageData,u as default};
